...
featureStoreName = 'my_efi_feature_store'  # ADD_FEATURE_STORE_NAME
modelStoreName = 'my_efi_feature_store'  # ADD_MODEL_STORE_NAME

solrEndpoint = 'http://localhost:8983'  # ADD_SOLR_ENDPOINT (eg: http://localhost:8983)
collection = 'techproducts'  # ADD_COLLECTION_NAME_IN_SOLR

# path and filename without the .xml extension,
# it'll output a JSON file in the same directory..
filename = 'C:\\Users\\rtarabco\\Downloads\\RankLib\\tags\\release-2.1\\mymodelFormat'
